        ...
        <div class="col-md-6 col-lg-5">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="mb-3">
                    ...
                    <x-input-error :messages="$errors->get('first_name')" class="text-danger mt-1" />
                </div>

                <!-- Middle Name -->
                <div class="mb-3">
                    <x-input-label for="middle_name" :value="__('Middle Name')" />
                    <x-text-input id="middle_name" class="form-control" type="text" name="middle_name" :value="old('middle_name')" />
                    <x-input-error :messages="$errors->get('middle_name')" class="text-danger mt-1" />
                </div>
                ...
                <div class="mb-3">
                    ...
                    <x-input-error :messages="$errors->get('last_name')" class="text-danger mt-1" />
                </div>
